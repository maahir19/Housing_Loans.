...
def load_and_train():
    ...
    df['downpayment_ratio']    = (df['Down_Payment_INR'] / df['Market_Value_INR'].replace(0,np.nan))
    ...
    numeric_features = ['Monthly_Income_Stated','Actual_Bank_Credit_Monthly','LTV_Ratio',
        ...
        'valuation_market_gap','downpayment_ratio']
...
def score_application(inputs, model, scaler, ohe, feature_names, numeric_features, categorical_features, doc_flag_cols, is_tree):
    ...
    down_payment = inputs.get('Down_Payment_INR', 0) or 0
    ...
    app['downpayment_ratio']    = (down_payment / market_value) if market_value else 0
    for col in categorical_features:
...
def render_loan_table(data, category):
    ...
    for col in ['Monthly_Income_Stated','Actual_Bank_Credit_Monthly','Annual_Income_Stated','ITR_Income_Last_FY','Loan_Amount_INR','Market_Value_INR','Down_Payment_INR']:
...
Divided by actual income: Rs{actual_credit:,}/mo
        ...
        with col3:
            ...
            down_payment   = st.number_input("Down Payment Amount (Rs)", 0, 50000000, 1500000, step=50000,
                                help="Borrower's own contribution toward the purchase.")
        ...
        if submitted:
            inputs = {
                ...
                'Market_Value_INR':market_value,'Down_Payment_INR':down_payment,
            ...
            # Credit enquiries
            if enquiries > 6:   overall_risk = max(overall_risk, 0.55)
            ...
            # Credit enquiries
            if enquiries > 6:
                breach_notes.append(f"CREDIT ENQUIRIES CRITICAL: {enquiries} enquiries in 30 days - strong indicator of loan desperation or multiple simultaneous applications.")
            elif enquiries > 3:
