    ...
    with tab2:
        ...
        with st.form("loan_form"):
            ...
            with col2:
                ...
                foir          = st.slider("FOIR (total obligations / income, post-loan)", 0.0, 1.0, 0.45, 0.01)
                tenure        = st.slider("Tenure (Years)", 1, 30, 15)
                emi           = 0  # not collected separately — FOIR slider captures total obligations
            with col3:
        ...
        if submitted:
            ...
            # Officer enters FOIR directly as post-loan total obligations ratio
            # No need to recompute — use it directly in both tier engine and floors
            actual_credit_safe = actual_credit if actual_credit > 0 else 1
            effective_foir = foir  # officer-entered post-loan FOIR
            # EMI as % of actual income — derived from loan params for display only
