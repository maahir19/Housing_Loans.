    ...
    with tab2:
        ...
        with st.form("loan_form"):
            ...
            with col2:
                ...
                # Auto-calculate new EMI from loan params
                _annual_rate   = 0.09
        ...
        if submitted:
            ...
            # FOIR is auto-calculated at input time: (existing EMI + new EMI) / actual income
            actual_credit_safe = actual_credit if actual_credit > 0 else 1
            effective_foir = foir  # auto-calculated post-loan FOIR (computed in form block above)
