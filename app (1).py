...
def main():
    ...
    with tab2:
        ...
        with col2:
            ...
            st.info(f"**Auto-calculated FOIR: {foir*100:.1f}%**  \nExisting EMI Rs{emi:,} + New EMI Rs{{_new_emi:,.0f}} = Rs{{emi+_new_emi:,.0f}} / Rs{{actual_credit:,}} income")
        with col3:
        ...
        submitted = st.button("Calculate Fraud Risk Score", use_container_width=True)
