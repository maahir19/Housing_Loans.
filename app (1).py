...
Divided by actual income: Rs{actual_credit:,}/mo
    ...
    with tab6:
        ...
        with kyc_tab1:
            ...
            with pan_col1:
                pan_input = st.text_input("PAN Number", max_chars=10,
                                          help="Format: 5 letters, 4 digits, 1 letter")
            with pan_col2:
                pan_name = st.text_input("Name as per PAN")
            pan_dob = st.text_input("Date of Birth", help="Format: DD/MM/YYYY")
        ...
        with kyc_tab2:
            ...
            with aadh_col1:
                aadhaar_input = st.text_input("Aadhaar Number", max_chars=14,
