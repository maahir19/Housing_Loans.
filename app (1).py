...
Divided by actual income: Rs{actual_credit:,}/mo
        ...
        with col3:
            ...
            market_value   = st.number_input("Market Value of Property (Rs)", 500000, 100000000, 7500000, step=100000,
                                help="From the valuation report.")
        ...
        if submitted:
            ...
            # Title_Chain_Clear='No' has almost no standalone fraud signal in the
            # data (~3.5-4.0% fraud rate, essentially flat), so it doesn't get a
            # hard floor like Collusive Valuer or RERA=No. But it should still never
            # be *free* to add on top of other findings - logically, 3 red flags
            # should never score the same as or lower than 2. This gives it a small,
            # honest nudge rather than zero weight.
            minor_dd_adder = 0.05 if title_chain == "No" else 0.0
