...
def load_and_train():
    ...
    categorical_features = ['Employment_Type','Loan_Purpose','Property_Type','Down_Payment_Source','Disbursement_Mode',
        'Valuation_Agency','RERA_Registered','CERSAI_Checked','Title_Chain_Clear','Legal_Opinion','Broker_Involved','Co_Applicant']
...
Divided by actual income: Rs{actual_credit:,}/mo
        ...
        if submitted:
            ...
            #  Blend: 70% credit (tier-based) + 30% critical doc risk 
            if n_critical > 0:
                overall_risk = 0.70 * credit_risk + 0.30 * doc_risk
            else:
                overall_risk = credit_risk
